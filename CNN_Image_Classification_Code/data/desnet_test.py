...
Optimizer = paddle.optimizer.Adam(learning_rate=0.01,parameters=desnet50.parameters())
...
def test(model, test_loader):
    ...
    print("test finished, acc={}".format(np.mean(acc_list)))
print("Model Batch size:")
bs=input()
print("Model learning rate")
lr=input()

desnet50.set_state_dict(paddle.load('output/desnet50-lr'+lr+'-bs'+bs+'.pdparams'))

Test_loader=paddle.io.DataLoader(test_dataset, batch_size=Batch_size)
test(desnet50,Test_loader)
